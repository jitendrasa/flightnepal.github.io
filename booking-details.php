        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="hotel-item">
                    <img src="assets/images/hotel-item1.jpg" alt="hotel-item1" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="hotel-item">
                    <img src="assets/images/hotel-item2.jpg" alt="hotel-item2" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="hotel-item">
                    <img src="assets/images/hotel-item3.jpg" alt="hotel-item3" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="hotel-item">
                    <img src="assets/images/hotel-item4.jpg" alt="hotel-item4" class="img-fluid">
                </div>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="extra-services">
                    <ul>
                        <li>
                            <input type="checkbox"><b>wifi:</b> 100 $ ( room/night ) = 100 $<br>
                        </li>
                        <li>
                            <input type="checkbox"><b>Car Rental:</b> 30 $ ( room/night ) = 30 $<br>
                        </li>
                        <li>
                            <input type="checkbox"><b>satellite tv:</b> 50 $ ( room/trip ) = 50 $<br>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="extra-services">
                    <ul>
                        <li>
                            <input type="checkbox"><b>sea view:</b> 10 $ ( room/night ) = 10 $<br>
                        </li>
                        <li>
                            <input type="checkbox"><b>laundary:</b> 10 $ ( guest/night ) = 10 $<br>
                        </li>
                        <li>
                            <input type="checkbox"><b>breakfast:</b> 10 $ ( room/trip ) = 10 $<br>
                        </li>
                    </ul>
                </div>
            </div>
